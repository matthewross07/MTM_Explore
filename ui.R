...
shinyUI(
  fluidPage(theme='bootstrap.css',
            sidebarLayout(
              sidebarPanel(p("This application shows how mining has changed the slope and elevation
                           ...
                           p(em("This application was built with support from Duke University's
